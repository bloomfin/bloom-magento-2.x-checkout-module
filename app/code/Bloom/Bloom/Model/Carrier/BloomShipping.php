<?php
namespace Bloom\Bloom\Model\Carrier;

use Magento\Quote\Model\Quote\Address\RateRequest;

class BloomShipping extends \Magento\Shipping\Model\Carrier\AbstractCarrier implements
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        $shippingPrice = 0.00;
        $title = 'Bloom Shipping';
        if ($token = $this->checkoutSession->getBloomToken()) {
